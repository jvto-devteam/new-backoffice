            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                ...
                <nav className="py-4 px-4 lg:px-6">
                    ...
                    <div>
                        ...
                        <h3 class="mb-4 ml-4 text-sm font-semibold text-bodydark2">BOOKINGS</h3>                        
                        <ul className="mb-6 flex flex-col gap-1.5">
                            {/* <!-- Menu Item Calendar --> */}
                            <li>
                                <Link
                            ...
                            <ul className="mb-6 flex flex-col gap-1.5">
                            <h3 class="mb-4 ml-4 text-sm font-semibold text-bodydark2">FINANCE</h3>
                            {/* <!-- Menu Item Profile --> */}
                            ...
                            <h3 class="mb-4 ml-4 text-sm font-semibold text-bodydark2">DATA MASTER</h3>                        
                            <ul className="mb-6 flex flex-col gap-1.5">
                            {/* <!-- Menu Item Forms --> */}
                            <SidebarLinkGroup
                                activeCondition={
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            ...
                                            <h3 class="mb-4 mt-6 ml-4 text-sm font-semibold text-bodydark2">TOOLS</h3>                        
                                            <ul className="mb-6 flex flex-col gap-1.5">
                                            <SidebarLinkGroup
                                                activeCondition={
