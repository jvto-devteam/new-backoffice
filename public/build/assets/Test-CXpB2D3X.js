import{r as c,j as e}from"./app-acOyxQtw.js";import{M as x}from"./Main-C6WMdNjA.js";import{C as g}from"./calendar-DGuUBj98.js";import{U as u}from"./users-fskDf8h6.js";import{T as f}from"./truck-D2aH-3ln.js";import{P as p}from"./plus-LUqIfJYU.js";import{C as b}from"./check-3ZY0fplC.js";import{T as v}from"./triangle-alert-CnY9J_OG.js";import{L as h}from"./loader-circle-DMWplbxC.js";import{A as j}from"./arrow-right-C6QoxqYD.js";import"./createLucideIcon-DmqpGgOX.js";const T=()=>{const[n,s]=c.useState(null),[a,r]=c.useState({}),i=t=>{r(o=>({...o,[t]:!0})),setTimeout(()=>{r(o=>({...o,[t]:!1})),s(t)},1e3)};return e.jsx(x,{children:e.jsx("div",{className:"min-h-screen bg-gray-50 dark:bg-gray-900 p-8",children:e.jsxs("div",{className:"space-y-12",children:[e.jsxs("section",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-white",children:"Interactive Buttons"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[e.jsx(m,{id:"create",label:"Create Booking",icon:g,gradient:"from-blue-500 to-indigo-500",isActive:n==="create",isLoading:a.create,onClick:()=>i("create")}),e.jsx(m,{id:"assign",label:"Assign Resources",icon:u,gradient:"from-purple-500 to-pink-500",isActive:n==="assign",isLoading:a.assign,onClick:()=>i("assign")})]})]}),e.jsxs("section",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-white",children:"Interactive Cards"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:[e.jsx(d,{title:"Tour Management",description:"Schedule and manage tours",icon:g,gradient:"from-cyan-500 to-blue-500"}),e.jsx(d,{title:"Resource Planning",description:"Organize guides and vehicles",icon:u,gradient:"from-purple-500 to-pink-500"}),e.jsx(d,{title:"Fleet Management",description:"Monitor vehicle status",icon:f,gradient:"from-emerald-500 to-teal-500"})]})]}),e.jsxs("section",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-900 dark:text-white",children:"State Buttons"}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4",children:[e.jsx(l,{label:"Default",icon:p,state:"default"}),e.jsx(l,{label:"Success",icon:b,state:"success"}),e.jsx(l,{label:"Warning",icon:v,state:"warning"}),e.jsx(l,{label:"Loading",icon:h,state:"loading"})]})]})]})})})},m=({id:n,label:s,icon:a,gradient:r,isActive:i,isLoading:t,onClick:o})=>e.jsx("button",{onClick:o,disabled:t,className:`
      relative group
