...
const renderEventContent = (eventInfo) => {
    const logoUrl = eventInfo.event.extendedProps.platform === 'klook' ? LOGOS.klook : LOGOS.jvto;

    return (
        <div className="flex items-center gap-2 px-1">
            <div className="w-5 h-5 shrink-0 rounded-full overflow-hidden bg-white flex items-center justify-center">
                <img
                    src={logoUrl}
                    alt="Platform logo"
