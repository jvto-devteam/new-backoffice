...
<head>
    <meta charset="UTF-8">
    <title>Customer by Country</title>
    <style>
        @page { margin: 20px; }
...
<body>
    ...
    <p class="subtitle">Period: {{ $period }} &nbsp;|&nbsp; Exported: {{ date('d M Y H:i') }} &nbsp;|&nbsp; {{ count($countries) }} countries</p>
    <table>
        <thead>
            <tr>
                <th style="width:4%">#</th>
    ...
    <p class="footer">JVTO Backoffice &mdash; Customer by Country &mdash; {{ date('d M Y H:i') }}</p>
</body>
</html>
