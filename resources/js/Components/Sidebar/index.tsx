  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 px-6 py-3.5 lg:py-4.5">
        <Link href="/">
          <img className="h-13" src="https://javavolcano-touroperator.com/assets/img/jvto-color.png" alt="Logo" />
        </Link>
        ...
        <nav className="py-4 px-4 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/summary-report' || pathname.includes('summary-report')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/summary-report' || pathname.includes('summary-report')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/summary-report/accommodations"
                              className={({ isActive }) =>
                          ...
                          <li>
                            <Link
                              href="/summary-report/transportation"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
